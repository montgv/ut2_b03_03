...
public class Ut2_b03_03 extends ApplicationAdapter {
	Stage stage;
	...
	public void create() {
		...
		stage = new Stage();
		Actor nave = new Nave();
		// Añadir el actor nave al stage y permitirle que gestione el teclado
		stage.addActor(nave);

		//Crear el actor meteorito
		Actor meteorito = new Meteorito();
		for (int i = 0; i < 10;i++){
